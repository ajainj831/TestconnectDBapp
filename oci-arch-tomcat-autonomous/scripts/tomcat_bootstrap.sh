...
wget -O /home/opc/TestconnectDBapp.war https://github.com/ajainj831/TestconnectDBapp/raw/main/TestconnectDBapp-1.war
chown opc:opc /home/opc/TestconnectDBapp.war
cp /home/opc/TestconnectDBapp.war /u01/apache-tomcat-${tomcat_version}/webapps
chown tomcat:tomcat /u01/apache-tomcat-${tomcat_version}/webapps/TestconnectDBapp.war
sleep 30
